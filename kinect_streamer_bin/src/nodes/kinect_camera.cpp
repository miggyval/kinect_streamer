...
int main(int argc, char** argv) {
    ...
    std::string serial = "226287140347";
    ...
    try {
        ...
        ros::Publisher pub_cloud = nh_cloud.advertise<sensor_msgs::PointCloud2>("/points", 1);
        while (ros::ok()) {
            kin_dev.wait_frames();
            ...
            libfreenect2::Frame* ir = kin_dev.get_frame(libfreenect2::Frame::Ir);
            ...
            cv::medianBlur(img_depth, img_depth, 5);
